...
do
	...
	do
		...
		do
			file_prefix=(${site}_${page_type}_${period})
			...
			then
				...
				psql -h pulse.cdc5dx3e4dfr.us-west-2.redshift.amazonaws.com -U read_only -d dev -p 5439 -f $sql_file -t -v period="'"$period"'" -v site="'"$site"'" > tmp.txt
			...
			./$Rscipt $site $page_type $period $new_max_count_file
